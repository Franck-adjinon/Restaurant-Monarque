...
from .models import Service_client, Email_send
...
def send_email_in_background_template(sujet, message, from_client):
    def email_task(): 
        ...
        Email_send.objects.create(nom="Client", email = from_client, message = message)
        # Mise en 
        html_content = render_to_string('emails/new_client.html', { 
